...
\begin{itemize}
	\item \textbf{Variance}: captures how much the model changes if you train it on a different training set. High variance indicates the model is \textit{over-specialized} or \textit{overfitting} to its specific dataset.
	\item \textbf{Bias}
\end{itemize}
