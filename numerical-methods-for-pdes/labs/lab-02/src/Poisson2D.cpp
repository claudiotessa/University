...
void Poisson2D::assemble() {
    ...
    // note how we do not evaluate gradients on the boundary
    FEFaceValues<dim> fe_values_boundary(
        *fe, *quadrature_boundary,
...
/*
double Poisson2D::compute_error(const VectorTools::NormType &norm_type,
